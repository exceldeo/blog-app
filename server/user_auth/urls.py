...
from user_auth.views import Register, ChangePassword, UpdateProfile, Logout, GetProfile,UpdateProfilePhoto, GetAllUsers
...
urlpatterns = [
    ...
    path('getAllUsers/', GetAllUsers.as_view(), name='auth_get_all_users'),
]
